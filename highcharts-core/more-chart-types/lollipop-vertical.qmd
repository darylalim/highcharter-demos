---
title: "Vertical Lollipop Chart Demo"
---

This is a demo of a vertical lollipop chart.

Highcharts Docs: [Vertical lollipop chart](https://www.highcharts.com/docs/chart-and-series-types/lollipop-series#vertical-lollipop-chart)
...
options(
  highcharter.chart = list(
    accessibility = list(
      ...
      point = list(
        valueDescriptionFormat = "{index}. {yDescription}, {point.x}."
      )
    )
  )
)
